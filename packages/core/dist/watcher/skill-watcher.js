...
export class SkillWatcher {
    ...
    watchEnvironments(environments) {
        const watchedPaths = [];
    ...
    async handleFileChange(changedPath, hostId) {
        ...
        if (!fs.existsSync(changedPath)) {
            ...
            if (existing) {
                ...
                const event = { type: 'deleted', filePath: changedPath, skill: existing };
...
//# sourceMappingURL=skill-watcher.js.map