import { RoutedDatabase, HybridRouter, RouteResult, SkillMetadata } from '../../../core/dist/index.js';
...
export async function runRoute(options: RouteCommandOptions): Promise<RouteResult> {
